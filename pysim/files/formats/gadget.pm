...
#####################################################################################################################################################################
    ...
    stat_pm    icgen    icgen      icgen    static_gdpm             rw_param      mk_param     small   shpfix   /home/langmm/code/Gadget/default.param
    ...
    exec       input    exec       input    Gadget2                 None          mk_exec      small   None     /home/langmm/code/Gadget/Gadget-2.0.6/Gadget2/Gadget2
    makefile   input    exec       input    Makefile                rw_makefile   mk_exec      small   None     /home/langmm/code/Gadget/Gadget-2.0.6/Gadget2/Makefile
    ic         input    ic         input    ic_gadget               rw_snap       mk_ic        small   None     None
    param      input    input      input    gdpar                   rw_param      mk_param     small   None     /home/langmm/code/Gadget/default.param
    pbs        input    input      input    gdpbs                   rw_pbs        mk_pbs       small   None     None
    sbatch     input    input      input    gdsbatch                rw_sbatch     mk_sbatch    small   None     None
    resub      input    input      input    resub                   rw_sub        mk_resub     small   None     None
    ...
    snapshot   output   snapshot   output   snapshot_{:03d}         rw_snap       None         large   None     None
    restart    output   restart    output   restart.{:d}            None          None         large   None     None
    restbak    output   restbak    output   restart.{:d}.bak        None          None         large   None     None
